...
* 2. [发起 Pull Request](#PullRequest-3)
	* 2.1. [搭建协作环境](#-4)
		...
		* 2.1.2. [Fork GitHub 仓库、初始化本地仓库](#ForkGitHub-6)
	* 2.2. [建立新分支](#-7)
	* 2.3. [在分支上工作](#-8)
	* 2.4. [发起 Pull Request](#PullRequest-9)
	* 2.5. [更新 Pull Request](#PullRequest-10)
	* 2.6. [删除分支](#-11)
	* 2.7. [如果你遇到问题](#-12)
* 3. [管理 Pull Request](#PullRequest-13)
...
####  2.1.2. <a name='ForkGitHub-6'></a>Fork GitHub 仓库、初始化本地仓库
...
###  2.4. <a name='PullRequest-9'></a>发起 Pull Request
...
###  2.5. <a name='PullRequest-10'></a>更新 Pull Request
...
##  3. <a name='PullRequest-13'></a>管理 Pull Request
